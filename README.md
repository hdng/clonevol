...
Tested R versions: 2.15, 3.0.2, 3.2.1, 3.2.3, 3.3.3, 3.4.0
...
However, users can specify their own colors. To set up the colors for the clusters/clones that will used throughout the visualizations, create a vector of colors as follow. In this case, we chose colors matching the original figure in Ding et al (2012).
